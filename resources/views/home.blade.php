                    ...
                    <div class="container">
                        ...
                        <div class="mobile_menu">
                            <ul class="site_links">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-item has_sub_menu">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-item"><a href="https://pas.gov.kw/">طلب تظلم إداري</a></li>
                                ...
                                <li class="nav-item"><a class="nav-link" href="https://pas.gov.kw/training/login"> التطوير والتدريب </a></li>
